...
impl Channel {
    ...
    /// builds can't be redirected away from their baked-in server URLs. Internal-only and OSS
    /// channels honor them for local development, testing, and self-hosted-compatible builds.
